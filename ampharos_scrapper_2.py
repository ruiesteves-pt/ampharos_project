...
# from ampharos_classes import * STILL DEBUGGING
import time
import pickle
            ...
            if i == 1:
                ...
                if split_b[1].isdigit():
                    ...
                    if split_b[3].isdigit():
                        ...
                        team_h = split_b[0] + split_b[1] + split_b[2] + split_b[3]
                        score_h = int(split_b[4])
                        score_a = int(split_b[5])
                        if split_b[7].isdigit():
                            team_a = split_b[6]
                        else:
                            team_a = split_b[6] + split_b[7]
                else:
